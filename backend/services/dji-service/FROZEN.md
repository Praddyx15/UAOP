...
This directory is **frozen pending OQ-1** (`docs/00_Project_Foundation/DECISIONS.md` §Open): DJI support (MSDK vs Cloud API) exists in no planning document and has no ADR.
